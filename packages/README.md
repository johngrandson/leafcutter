...
valida path/realpath, Mix project, manifest raiz, digest, ownership do módulo, topology e
behaviours antes de embutir a inventory. `mix quality` também prova a closure da release e
executa os gates próprios de cada package listado.
