...
- Status: Accepted
- Estado de implementação: MATERIALIZADO — SLICE 26A CONCLUÍDO
...
Novas ContractVersions persistem schema Draft 2020-12 imutável, são validadas e construídas com JSV na publicação e expõem compilação e validação reutilizáveis. Novas PackageVersions, novos EnvironmentDeployments e novas resoluções de Run rejeitam ContractVersions identity-only legadas.
