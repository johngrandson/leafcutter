...
| ADR-0007 | Integration Packages fora de `apps/` | ESTRUTURA + BUILD CONTRACT RATIFICADOS; NÃO MATERIALIZADO |
| ADR-0008 | Connector → Operation → Transport | PARCIAL — METADATA + OPERATION + HTTP; 26C2 RATIFICADO |
...
| ADR-0023 | Package Manifest, build binding e module resolution | NÃO MATERIALIZADO — 26C2 RATIFICADO |
