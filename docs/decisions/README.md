...
| ADR-0007 | Integration Packages fora de `apps/` | PARCIAL — MANIFEST + BINDING + DIGEST; BUILD PENDENTE |
| ADR-0008 | Connector → Operation → Transport | PARCIAL — METADATA + OPERATION + HTTP + 26C2/PASSOS 35–36 |
...
| ADR-0023 | Package Manifest, build binding e module resolution | PARCIAL — PASSOS 35–36 MATERIALIZADOS |
