...
| ADR-0007 | Integration Packages fora de `apps/` | PARCIAL — MANIFEST + BINDING MATERIALIZADOS; BUILD PENDENTE |
| ADR-0008 | Connector → Operation → Transport | PARCIAL — METADATA + OPERATION + HTTP + 26C2/PASSO 35 |
...
| ADR-0023 | Package Manifest, build binding e module resolution | PARCIAL — PASSO 35 MATERIALIZADO |
