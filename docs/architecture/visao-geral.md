...
O Slice 26A ratificado no ADR-0019 está materializado em PackageVersion, EnvironmentDeployment create/replace e no resolver de Run. A boundary executável de Operation do Slice 26B está materializada conforme o ADR-0021; HTTP permanece aberto no Slice 26C.
