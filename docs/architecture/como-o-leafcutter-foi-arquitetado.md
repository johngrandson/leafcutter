...
Integration já é uma identidade lógica materializada dentro da Organization. EnvironmentDeployment selecionará PackageVersion, bindings, configs e Triggers por Environment.
