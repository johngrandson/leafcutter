...
A foundation inicial, RunSnapshot v1 e o workflow completo `EnvironmentDeployment → RunSnapshot v1` estão materializados. Os Slices 26A, 26B, 26C1 e 26C2 estão concluídos conforme ADR-0019, ADR-0021, ADR-0022 e ADR-0023. Manifest, binding compilada, `PackageVersion.manifest_sha256`, inventory/release e resolução por digest estão materializados sem alterar RunSnapshot v1. A próxima fronteira é ratificar a primeira referência real em 26C3.
